...
import pytest
from source_deployteq.source import DeployteqStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DeployteqStream, "path", "v0/example_endpoint")
    mocker.patch.object(DeployteqStream, "primary_key", "test_primary_key")
    mocker.patch.object(DeployteqStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = DeployteqStream()
